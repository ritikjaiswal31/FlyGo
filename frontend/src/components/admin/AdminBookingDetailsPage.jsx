...
const AdminBookingDetailsPage = () => {
    ...
    if (loading) return <div className="admin-booking-loading">Loading booking details...</div>;
    if (!booking) return <div className="admin-booking-error">Booking not found</div>;
